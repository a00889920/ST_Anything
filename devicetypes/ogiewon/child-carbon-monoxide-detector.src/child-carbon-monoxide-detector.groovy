 ...
 *    2020-09-27  Dan Ogorchock  Tweaked metadata section for new ST App, removed lastUpdated attribute 
 *
 * 
 */
metadata {
	definition (name: "Child Carbon Monoxide Detector", namespace: "ogiewon", author: "Dan Ogorchock", ocfDeviceType: "x.com.st.carbonmonoxidedetector", vid: "generic-carbon-monoxide") {
